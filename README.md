...
| Rotation Solver Reborn | `7.3.0.72` | 已避開台服不相容的 DTR API，並補回 AutoDuty 專用 IPC；技能組基底仍早於 7.38 |
...
| Rotation Solver Reborn | `7.3.0.72` | 13 | 台服 API 13 可載入版；已補 AutoDuty 自動啟停與目標模式 IPC |
